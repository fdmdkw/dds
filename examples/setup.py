...
#raspberry pi
g++ -fPIC -O3 -flto -fopenmp -Ofast -mtune=arm1176jzf-s -mfloat-abi=hard -march=armv6zk -std=c++11 -fopenmp -lboost_system -lboost_thread -DDDS_THREADS_BOOST -DDDS_THREADS_OPENMP -DDDS_THREADS_STL ddsTable.cpp -c ddsTable.o
